...
uses Windows,clipbrd,dbctrls,comctrls,Dialogs,Graphics,TypInfo,
     Forms,controls,DbConsts,stdctrls,
     EtvConst,EtvPas,EtvTable,EtvContr,EtvGrid,EtvDBFun,EtvForms,EtvOther,
     DiPara,EtvRich;
...
begin
  ...
  InsertItem(1,SPopupBaseFont,SetBaseFont,0);

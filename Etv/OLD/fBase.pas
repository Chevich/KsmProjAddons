...
uses
  ...
  Forms,DBCtrls,DB,DBGrids,DBTables,Grids,ExtCtrls,Menus,Buttons,ComCtrls,
  EtvGrid,EtvFind,EtvContr,EtvForms,EtvFilt;
...
begin
  ...
  if (((Not AutoWidth(EtvDBGrid.Canvas.TextWidth('0'),45,EtvDBGrid.TitleRows<=0)) or
       PageNeed) and (PageControl1.PageCount=1)) or
    ...
    if (DataSource.DataSet is TTable) and TTable(DataSource.DataSet).ReadOnly then begin

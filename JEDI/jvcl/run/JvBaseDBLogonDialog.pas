...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvBaseDBLogonDialog.pas 12318 2009-05-30 09:32:07Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvBaseDBLogonDialog.pas $';
    Revision: '$Revision: 12318 $';
    Date: '$Date: 2009-05-30 11:32:07 +0200 (sam., 30 mai 2009) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}

...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDSADialogs.pas 12317 2009-05-30 09:30:38Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvDSADialogs.pas $';
    Revision: '$Revision: 12317 $';
    Date: '$Date: 2009-05-30 11:30:38 +0200 (sam., 30 mai 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

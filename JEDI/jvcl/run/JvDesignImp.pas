...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDesignImp.pas 12290 2009-04-29 12:25:33Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvDesignImp.pas $';
    Revision: '$Revision: 12290 $';
    Date: '$Date: 2009-04-29 14:25:33 +0200 (mer., 29 avr. 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

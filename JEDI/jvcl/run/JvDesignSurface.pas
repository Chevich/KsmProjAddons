...
-----------------------------------------------------------------------------}
// $Id: JvDesignSurface.pas 12300 2009-04-29 17:13:53Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvDesignSurface.pas $';
    Revision: '$Revision: 12300 $';
    Date: '$Date: 2009-04-29 19:13:53 +0200 (mer., 29 avr. 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

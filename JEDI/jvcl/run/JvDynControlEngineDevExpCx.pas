...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDynControlEngineDevExpCx.pas 12286 2009-04-26 19:29:53Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvDynControlEngineDevExpCx.pas $';
    Revision: '$Revision: 12286 $';
    Date: '$Date: 2009-04-26 21:29:53 +0200 (dim., 26 avr. 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

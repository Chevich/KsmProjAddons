...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDynControlEngineVCL.pas 12322 2009-05-30 19:18:14Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvDynControlEngineVCL.pas $';
    Revision: '$Revision: 12322 $';
    Date: '$Date: 2009-05-30 21:18:14 +0200 (sam., 30 mai 2009) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}

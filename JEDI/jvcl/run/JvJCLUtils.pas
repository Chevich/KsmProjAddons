...
-----------------------------------------------------------------------------}
// $Id: JvJCLUtils.pas 12338 2009-06-11 19:50:41Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvJCLUtils.pas $';
    Revision: '$Revision: 12338 $';
    Date: '$Date: 2009-06-11 21:50:41 +0200 (jeu., 11 juin 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

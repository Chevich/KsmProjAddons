...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvLinkedControls.pas 12303 2009-05-04 16:08:02Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvLinkedControls.pas $';
    Revision: '$Revision: 12303 $';
    Date: '$Date: 2009-05-04 18:08:02 +0200 (lun., 04 mai 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

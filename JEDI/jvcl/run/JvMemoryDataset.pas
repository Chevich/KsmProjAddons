...
-----------------------------------------------------------------------------}
// $Id: JvMemoryDataset.pas 12334 2009-06-08 20:56:55Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvMemoryDataset.pas $';
    Revision: '$Revision: 12334 $';
    Date: '$Date: 2009-06-08 22:56:55 +0200 (lun., 08 juin 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

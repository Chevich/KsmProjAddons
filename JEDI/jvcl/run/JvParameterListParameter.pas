...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvParameterListParameter.pas 12310 2009-05-18 23:21:04Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvParameterListParameter.pas $';
    Revision: '$Revision: 12310 $';
    Date: '$Date: 2009-05-19 01:21:04 +0200 (mar., 19 mai 2009) $';
    LogPath: 'JVCL\run'
    );
  {$ENDIF UNITVERSIONING}

...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvPropertyStorage.pas 12340 2009-06-15 16:29:26Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvPropertyStorage.pas $';
    Revision: '$Revision: 12340 $';
    Date: '$Date: 2009-06-15 18:29:26 +0200 (lun., 15 juin 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

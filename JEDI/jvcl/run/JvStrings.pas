...
-----------------------------------------------------------------------------}
// $Id: JvStrings.pas 12339 2009-06-15 16:25:23Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvStrings.pas $';
    Revision: '$Revision: 12339 $';
    Date: '$Date: 2009-06-15 18:25:23 +0200 (lun., 15 juin 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

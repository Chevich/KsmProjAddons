...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvThread.pas 12302 2009-05-03 22:08:38Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvThread.pas $';
    Revision: '$Revision: 12302 $';
    Date: '$Date: 2009-05-04 00:08:38 +0200 (lun., 04 mai 2009) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}

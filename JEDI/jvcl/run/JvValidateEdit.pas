...
-----------------------------------------------------------------------------}
// $Id: JvValidateEdit.pas 12314 2009-05-25 18:29:53Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile:
      '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_37_PREPARATION/run/JvValidateEdit.pas $';
    Revision: '$Revision: 12314 $';
    Date: '$Date: 2009-05-25 20:29:53 +0200 (lun., 25 mai 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}

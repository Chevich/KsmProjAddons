...
{ TXNotifyEvent }
  ...
  public
    ...
    procedure GoSpellChild(AComponent: TComponent; AEvent: Word; AChild: TPersistent;
...
{ TXNotifyString }
  ...
  private
    FStr: String;
  public
    procedure GoSpellStr(AComponent: TComponent; AEvent: Word;
...
var F:Text; { Файл отчета об ошибках при отлове Accsess Violation }
...
Finalization
  ...
  if CaptureErrorMode then Close(F);
end.

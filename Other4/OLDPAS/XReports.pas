...
Uses SysUtils, Controls, Forms, Dialogs, DB, ppComm, ppClass, XTxtDev,
...
{   Exit;}
  ...
  PrinterSetup:=TXTextPrintDevice(FTextPrinterDevice).Printer.PrinterSetup;

...
uses
  ...
  ExtCtrls, vgCtrls, CommCtrl, ComCtrls, vgTools, ExplFile, StdCtrls, Menus,
  Buttons, Explorer, ExplCtrl;
...
implementation
uses vgUtils {$IFDEF _D4_}, ImgList {$ENDIF};
...
begin
  Node := tvDrives.Selected;
  if ExplorerNodes is TExplorerDirNode then
  begin

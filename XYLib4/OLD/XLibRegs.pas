...
Uses Windows, Dialogs, Classes, Controls, Graphics, DsgnIntf, ExtCtrls, Menus,
     ...
     Nav, TFCProps, XLbProps, ExptIntf, XECtrls, XEFields, XETrees, LnkSet,
     AEForms, BEForms, ABEForms, BBEForms, MBEForms, Splash, TlsForm
{$IFDEF Report_Builder}
     , ppCDReg, XReports, XLnkPipe{, ppXForms}
{$ENDIF}
     ;
...
begin
  ...
  RegisterComponents('XControls', [TXLabel,{ TXDBNavigator,} TXDBLabel
{$IFDEF Report_Builder}
                     , TXDBReport
{$ENDIF}
                     ]);

// ***************************************************************
//  madCHook - dynamic.h      version:  2.1i  ·  date: 2008-07-25
//  -------------------------------------------------------------
...
// normally madCodeHook renews hooks whenever a new dll is loaded
// hooks are renewed when they were removed and when they were overwritten
// this flag limits the renewing to situations when the hook was removed
// so if other hooking libraries overwrite our hook, we won't undo that
// param: unused
#define DONT_RENEW_OVERWRITTEN_HOOKS (DWORD) 0x00000008
